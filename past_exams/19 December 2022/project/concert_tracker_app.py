...
class ConcertTrackerApp:
    ...
    def create_musician(self, musician_type: str, name: str, age: int):
        ...
        self.ALL_MUSICIANS.append(name)
    ...
    @staticmethod
    def __find_musician_in_given_band(band, name):
    ...
    def remove_musician_from_band(self, musician_name: str, band_name: str):
        band = self.__find_band_by_name(band_name)
        musician = self.__find_musician_in_given_band(band, musician_name)
    ...
    def start_concert(self, concert_place: str, band_name: str):
        ...
        each_type_member = {x.__class__.__name__ for x in band.members}

        if len(each_type_member) < 3:
        ...
        if concert.genre == 'Rock':
            for band_member in band.members:
                ...
                if band_member.__class__.__name__ == 'Singer' and 'sing high pitch notes' \
                        not in band_member.skills:
                    raise Exception(f"The {band_name} band is not ready to play at the concert!")
                if band_member.__class__.__name__ == 'Guitarist' and 'play rock' \
                        not in band_member.skills:
                    raise Exception(f"The {band_name} band is not ready to play at the concert!")
            ...
            for band_member in band.members:
                if band_member.__class__.__name__ == 'Drummer' and 'play the drums with drumsticks' \
                        not in band_member.skills:
                    raise Exception(f"The {band_name} band is not ready to play at the concert!")
                if band_member.__class__.__name__ == 'Singer' and 'sing low pitch notes' \
                        not in band_member.skills:
                    raise Exception(f"The {band_name} band is not ready to play at the concert!")
                if band_member.__class__.__name__ == 'Guitarist' and 'play metal' \
                        not in band_member.skills:
                    raise Exception(f"The {band_name} band is not ready to play at the concert!")

        elif concert.genre == 'Jazz':
            for band_member in band.members:
                if band_member.__class__.__name__ == 'Drummer' and 'play the drums with drum brushes' \
                        not in band_member.skills:
                    raise Exception(f"The {band_name} band is not ready to play at the concert!")
                if band_member.__class__.__name__ == 'Singer' and ("sing low pitch notes" not in band_member.skills
                    ...
                    raise Exception(f"The {band_name} band is not ready to play at the concert!")
                if band_member.__class__.__name__ == 'Guitarist' and 'play jazz' \
                        not in band_member.skills:
                    raise Exception(f"The {band_name} band is not ready to play at the concert!")
