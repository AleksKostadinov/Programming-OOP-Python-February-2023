...
class Concert:
    ...
    def genre(self, value):
        Validation.check_not_in(value, self.needed_musicians_and_skills,
    ...
    def place(self, value):
        Validation.check_if_string_is_less_than(value, f'Place must contain at least 2 chars. It cannot be empty!')
